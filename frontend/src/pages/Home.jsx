import React from 'react'
 ...
 import prants from '../assets/parents.png'
 import nanny from '../assets/nanny.png'
import aged from '../assets/aged.png'
 function Home() {
  return (
    <div>    <div  className='h-200 py-70 items-center bg-center' style={{backgroundImage:(`url(${bg})`),backgroundPosition:""}}>
...
<br />the problem.
    ...
    <Services img={prants} first={"Parents Care"} second={"Provides a simple, inexpensive, and extremely effective way."} ></Services>
    <Services img={aged} first={"Nanny Care"} second={"Provides a simple, inexpensive, and extremely effective way."} ></Services>
    <Services img={prants} first={"Aged Person Care"} second={"Provides a simple, inexpensive, and extremely effective way."} ></Services>
